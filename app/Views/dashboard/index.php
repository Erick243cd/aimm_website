                        ...
                        <div class="col-sm-4 text-center">
                            <div class="card support-bar overflow-hidden">
                                <div class="card-body pb-0">
                                    ...
                                    <span class="text-c-green"><strong><a href="<?= base_url()?>/list-posts">ACTIVITES</a></strong></span>
                                    <p class="mb-3 mt-3"><a href="">Total Activités</a></p>
                                </div>
                                <div class="card-footer text-dark">
                                    <div class="row text-center">
                                        <div class="col">
                                            <a type="button" href="<?= base_url()?>/add-post" data-toggle="tooltip" data-placement="top" title="Ajout Image"
                                        ...
                                        <div class="col">
                                            <a type="button" href="<?= base_url()?>/list-posts" data-toggle="tooltip" data-placement="top" title="Liste"
